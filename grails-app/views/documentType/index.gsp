	...
	<body>
		...
		<div id="list-documentType" class="content scaffold-list" role="main">
			...
			<thead>
				...
				<g:each in="${documentTypeInstanceList}" status="i" var="documentTypeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${documentTypeInstance.id}">${fieldValue(bean: documentTypeInstance, field: "description")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${documentTypeInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
